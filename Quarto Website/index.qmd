...
I was then having further issues with installation, when I was stuck in a loop of "Updating Loaded Packages" when trying to test the install.packages section.
